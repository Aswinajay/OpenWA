...
- The dashboard Sessions page re-reads the session list once after any read that fails while live updates are connected, instead of keeping the error until a reload.
